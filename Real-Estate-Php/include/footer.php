                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        ...
                                        <p class="pb-20 text-white">At Deshmukh Estate, we’re committed to turning your real estate dreams into reality. Whether you’re searching for your first home, an investment property, or a commercial space, we offer a wide range of options tailored to your needs.

.</p>
										<p class="pb-20 text-white">Finding the perfect property is more than just a transaction; it’s a life-changing decision. At Deshmukh Estate, we understand the importance of this journey and strive to make it memorable and stress-free.</p>
                                        </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>Pune Maharashtra </li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>7758885221</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>9850648178</li>
                                                    <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>karandeshmukh@gmail.com</li>
                                                </ul>
                                            </div>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© 2024 Deshmukh Estates  All right reserved</span> </div>
                    <div class="col-sm-6">

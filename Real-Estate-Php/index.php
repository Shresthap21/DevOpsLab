                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We help you sell your property quickly and at the best price. Our team ensures effective marketing and a smooth selling process.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Looking to rent or lease a property? We connect you with the perfect tenants or rental spaces hassle-free.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Showcase your property on our platform to reach a wider audience. Our listings are designed to attract serious buyers and renters .</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Make secure real estate investments with our expert legal guidance. We ensure compliance with all regulations, giving you peace of mind.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>At Deshmukh Estate, we take pride in offering unparalleled quality in every aspect of our service. From premium property options to personalized support, we ensure an experience that exceeds expectations</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										<h5 class="mb-3">Experience Quality</h5>
										<p>With years of industry experience, Deshmukh Estate brings a wealth of knowledge to help you make informed decisions. From market insights to tailored solutions, we guide you every step of the way.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										<h5 class="mb-3">Experience Quality</h5>
										<p>Every property by Deshmukh Estate is a testament to superior design and construction. We ensure that every detail, from layout to finishes, reflects exceptional quality and timeless elegance.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Browse through our curated collection of premium properties tailored to meet your needs and preferences.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Contact our team to book a personalized tour and experience the quality and features of your chosen properties firsthand..</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Once you’ve found your perfect match, our experts will guide you through a smooth and transparent process to finalize your purchase or lease.</p>
                        </div>
                    </div>
                </div>
            </div>

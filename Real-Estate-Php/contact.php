                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-secondary">Amanora Town , Hadapsar, pune</span> 
										<span class="text-secondary">Amanora Town , Hadapsar, pune</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="d-table text-secondary">91+ 77588888521</span>
										<span class="text-secondary">91+ 77588888521</span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-secondary">deshmukhestates@gmail.com</span>
										<span class="text-secondary">helpline@deshmukhestates.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
